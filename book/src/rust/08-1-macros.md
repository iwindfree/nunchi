...
nunchi에 직접 만든 매크로가 **하나** 있습니다. 그 하나를 뜯어봅니다.
...
**두 곳만 고치고 한 곳을 잊으면 조용히 틀립니다.** 그래서 매크로로 묶었습니다.
...
반복되고, 값을 추가할 때 여러 곳을 함께 고쳐야 하는 상황이었기에 값을
했습니다. 두 번 반복하는 정도였다면 그냥 두 번 썼을 것입니다.
...
`str_enum!`이 만들어 내는 코드를 손으로 적어 보십시오.
