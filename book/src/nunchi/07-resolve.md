...
도달할 수 없는 값**이었습니다. 도달할 수 없는 목표를 띄우는 지표는 진단에
...
파일 사이의 참조를 잇기 위해 두 번 돕니다. 1패스에서 심볼을 전부 만들고
2패스에서 이름으로 찾습니다.

후보 수에 따라 확신도를 다르게 줍니다. 넷 이상이면 포기하는데, 흔한 이름이
